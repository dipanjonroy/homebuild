...
export default function index() {
  return (
    <section className="scroll-height w-full h-dvh 2xl:h-200">
        ...
        <div className="relative site-container z-100">
          <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-4 white-text">
            <div className="w-full max-w-130">
              <span className="block mb-8"> [ About Us ]</span>
              <h1 className="heading font-bold text-4xl lg:text-5xl tracking-tight leading-10 lg:leading-12 xl:leading-tight">
                Building With Purpose, Crafting With Pride
              </h1>
            </div>

            <p className="w-full max-w-130 lg:text-right text-sm lg:text-base">
              We believe great construction is more than putting materials
              together—it’s about creating spaces that last, inspire, and make a
              difference. With skilled craftsmanship, honest communication, and
              attention to every detail, we bring each client’s vision to life.
            </p>
          </div>
        </div>
      </div>
